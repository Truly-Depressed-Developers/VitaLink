        ...
        <Link href={"/connected-devices"}>
          ...
          >
            <path
              ...
              stroke={
                pathname === "/connected-devices" ? selectedColor : color
              }
              strokeWidth="2"
              strokeLinecap="round"
        ...
        <Link href={"/reminders"}>
          ...
          >
            <path
              ...
              stroke={
                pathname === "/reminders" ? selectedColor : color
              }
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link href={"/reports"}>
          ...
          >
            <path
              ...
              stroke={
                pathname === "/reports" ? selectedColor : color
              }
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link href={"/senior-view"}>
          ...
          >
            <path
              ...
              fill={
                pathname === "/senior-view" ? selectedColor : color
              }
            />
          </svg>
        </Link>
