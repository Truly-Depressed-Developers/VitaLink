...
const Nav = () => {
  ...
  return (
    <div className="z-40 w-full">
      <div className="mx-auto flex w-11/12 justify-evenly rounded-lg bg-primary py-2 shadow-md">
        <Link href={"/connected-devices"}>
          ...
          >
            <path
              ...
              stroke={pathname === "/connected-devices" ? selectedColor : color}
              strokeWidth="2"
              strokeLinecap="round"
        ...
        <Link href={"/reminders"}>
          ...
          >
            <path
              ...
              stroke={pathname === "/reminders" ? selectedColor : color}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
        ...
        <Link href={"/reports"}>
          ...
          >
            <path
              ...
              stroke={pathname === "/reports" ? selectedColor : color}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
        ...
        <Link href={"/senior-view"}>
          ...
          >
            <path
              ...
              fill={pathname === "/senior-view" ? selectedColor : color}
            />
          </svg>
        </Link>
      </div>
